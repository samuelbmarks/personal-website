...
export class ThemeService {
  ...
  public updateThemeProperties(theme: string) {
    ...
    else if (theme == "theme-pinto") {
      this.currentTheme = "theme-pinto";
    ...
    else if (theme == "theme-elo") {
      this.currentTheme = "theme-elo";
    ...
    else if (theme == "theme-grace") {
      this.currentTheme = "theme-grace";
    ...
    else if (theme == "theme-yoshi") {
      this.currentTheme = "theme-yoshi";
